...
class BioFieldController {
	def bioFieldControllerService
	...
	def update = {
		...
		if(bioFieldControllerService && (bioFieldControllerService.metaClass.pickMethod("update", [Object.class] as Class[]) || bioFieldControllerService.metaClass.pickMethod("update", [Object.class, Object.class] as Class[]))){
			def bioFieldInstance
			def success
			if(bioFieldControllerService.metaClass.pickMethod("create", [Object.class, Object.class] as Class[] )) (bioFieldInstance, success) = bioFieldControllerService.update( params, request )
			else (bioFieldInstance, success) = bioFieldControllerService.update( params )
	...
	def save = {
		...
		if(bioFieldControllerService && (bioFieldControllerService.metaClass.pickMethod("create", [Object.class] as Class[]) || bioFieldControllerService.metaClass.pickMethod("create", [Object.class, Object.class] as Class[] ))){
			def bioFieldInstance
			def success
			if(bioFieldControllerService.metaClass.pickMethod("create", [Object.class, Object.class] as Class[] )) (bioFieldInstance, success) = bioFieldControllerService.create( params, request )
			else (bioFieldInstance, success) = bioFieldControllerService.create( params )
			withFormat {
				html { render(view: "show", model: [bioFieldInstance: bioFieldInstance]) }
                xml { render bioFieldInstance as XML }
